...
let clearContainer = (container: HTMLElement) => {
    while (container.firstChild) {
        container.removeChild(container.firstChild);
    }
}

let appendLiToUl = (text: string, ul: Node) => {
...
let resetInventors = () => {
    var inventorsContainer: HTMLElement = document.getElementById("inventors");
    clearContainer(inventorsContainer);

    var ul : Node = inventorsContainer.appendChild(document.createElement("ul"));
...
let resetPeople = () => {
    var peopleContainer: HTMLElement = document.getElementById("people");
    clearContainer(peopleContainer);

    var ul : Node = peopleContainer.appendChild(document.createElement("ul"));
...
let resetTransportations = () => {
    var transportationsContainer: HTMLElement = document.getElementById("transportations");
    clearContainer(transportationsContainer);

    var ul : Node = transportationsContainer.appendChild(document.createElement("ul"));
